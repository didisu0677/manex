...
class Cogs_idle extends BE_Controller {
    var $controller = 'cogs_idle';
    ...
    function data($tahun="",$divisi="",$category="",$sector="",$tipe = 'table'){
        ...
        $table = 'tbl_budget_cogsidle_' . $tahun; 
        ...
        $response	= array(
            'table'		=> $this->load->view('budget_sales/cogs_idle/table',$data,true),
            'table2'		=> $this->load->view('budget_sales/cogs_idle/table2',$data,true),
            'table3'		=> $this->load->view('budget_sales/cogs_idle/table3',$data,true),
        );
    ...
    function save_perubahan() {       
        ...
        $table = 'tbl_budget_cogsidle_'.post('tahun');
    ...
    function template() {
        ...
        $tahun = get('tahun');
        $data = get_data('tbl_budget_cogsidle_'.$tahun)->result_array();
        ...
        $config = [
            'title' => 'template budget cogsidle',
            'header' => $arr,
