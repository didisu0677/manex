...
class Price_list extends BE_Controller {
    ...
    function data($tahun="",$divisi="",$category="",$sector="",$tipe = 'table'){
        ...
        $response	= array(
            ...
            'table2'		=> $this->load->view('budget_sales/price_list/table2',$data,true),
            'table3'		=> $this->load->view('budget_sales/price_list/table3',$data,true),
        );
    ...
    function import() {
        ...
        // $totalData = array();
            ...
            // $x = $this->simpleexcel->parsing(0,2);
            // $file = strpos($x['PRODUCT'], "-");

            // $result = substr($x['PRODUCT'], 0, $file);
            // if($result != $filter['tab']) {
            //     $response = [
            //         'status' => 'failed',
            //         'message' => 'File Import tidak sesuai'
            //     ];
            //     render($response,'json');
            //     die;
            // }

            // if($this->simpleexcel->parsing(0,$i+1) != $filter['tab']){
            //     $response = [
            //         'status' => 'failed',
            //         'message' => 'File Impor yang anda gunakan salah'
            //     ];
            //     render($response,'json');
            // }
