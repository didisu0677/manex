		...
		<div class="card-body tab-content" id="pills-tabContent">
			<div class="tab-pane fade show active" id="overall" role="tabpanel" aria-labelledby="overall-tab">
				<div class="table-responsive" id="result">
							...
							for ($i = 1; $i <= 12; $i++) {
								...
								th($actual . ' ' . month_lang($i), '', 'class="text-center" style="min-width:50px"');
							}
							th('Total BE ' . (user('tahun_budget')-1), '', 'class="text-center align-middle headcol"style="min-width:50px"');
							th('BUDGET ' . (user('tahun_budget')-1), '', 'class="text-center align-middle headcol"style="min-width:50px"');
							th('ACH - ' . (user('tahun_budget')-1), '', 'class="text-center align-middle headcol"style="min-width:50px"');
							th('ACTUAL ' . (user('tahun_budget')-2), '', 'class="text-center align-middle headcol"style="min-width:50px"');
							th('GROWTH ' . (user('tahun_budget')-1), '', 'class="text-center align-middle headcol"style="min-width:50px"');
			...
			<div class="tab-pane fade" id="budget" role="tabpanel" aria-labelledby="budget-tab">
				<div class="table-responsive" id="result2">
							...
							for ($i = 1; $i <= 12; $i++) {
								...
								th(month_lang($i), '', 'class="text-center" style="min-width:50px"');
							}
							th('Total', '', 'class="text-center align-middle headcol"style="min-width:50px"');
							tbody();
							table_close();
							?>
				</div>
			...
			<div class="tab-pane fade" id="detail" role="tabpanel" aria-labelledby="detail-tab">
				<div class="table-responsive" id="result3">
							...
							th('Code', '', 'class="text-center align-middle headcol"');
							th('Sector', '', 'class="text-center align-middle headcol"');
							th('Actual ' . (user('tahun_budget') -1), '', 'class="text-center" style="min-width:50px"');

							for ($i = user('tahun_budget'); $i <= user('tahun_budget')+10; $i++) {
	
								th($i, '', 'class="text-center" style="min-width:50px"');
							}
							// th('Total', '', 'class="text-center align-middle headcol"style="min-width:50px"');
							tbody();
							table_close();
...
modal_body();
	form_open(base_url('budget_sales/net_sales/import'),'post','form-import');
		col_init(3,9);
...
<script type="text/javascript">
	...
	function refresh_page() {
        $(document).on('click', '.swal-button--confirm', function(){
            setTimeout(function () {
                window.location.href = '<?php echo site_url('budget_sales/net_sales') ?>';
            }, 1000);
        })
    }
