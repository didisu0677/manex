...
class Ovh_perunit extends BE_Controller {
        ...
        foreach($data['grup'][0] as $m0) {	
            ...
            $data['produk'][$m0->id]= get_data('tbl_fact_product_ovh a',[
                ...
                'where' => [
                    ...
                    '__m' => 'a.product_code in (select budget_product_code from tbl_beginning_stock where is_active ="1" and tahum="'.$tahun.'")'
                    // 'a.qty_production !=' => 0
                ],
    ...
    //    debug($total_biaya);die;
        $response	= array(
            'table'		=> $this->load->view('reporting/ovh_perunit/table',$data,true),
        );
