...
class Rprod_qcallocation_actual extends BE_Controller {
    ...
    function data($tahun = "", $bulan ="", $cost_centre="" , $tipe = 'table') {
        ...
        $response	= array(
            'table'		=> $this->load->view('reporting/rprod_qcallocation_actual/table',$data,true),
        );
    ...
    function save_alokasi() {
        ...
        $produk = get_data('tbl_fact_allocation_qc_actual a',[
        ...
        foreach($produk as $p) {
            ...
            update_data('tbl_fact_allocation_qc_actual',['direct_labour' => $direct_labour,'utilities' => $utilities,'supplies' => $supplies,
