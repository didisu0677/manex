...
class Ovh_perunit_actual extends BE_Controller {
    var $controller = 'ovh_perunit';
    ...
    function data($tahun = "",$bulan ="" , $cost_centre="" , $tipe = 'table') {
        ...
        foreach($data['grup'][0] as $m0) {	
            ...
            $data['produk'][$m0->id]= get_data('tbl_fact_product_ovh_actual a',[
                ...
                'join' =>  ['tbl_fact_allocation_qc_actual d on a.tahun = d.tahun and a.bulan = d.bulan and a.product_code = d.product_code',
                ...
                'where' => [
                    ...
                    '__m' => 'a.product_code in (select budget_product_code from tbl_beginning_stock where is_active ="1" and tahun="'.user('tahun_budget').'")',
                    'a.qty_production !=' => 0
                ],
            ...
            $new_alloc2 = get_data('tbl_add_alloc_product_actual',[
                'where' => [
                    'tahun' => $tahun,
                    'bulan' => $bulan,
                    'account_code' => '736'
    ...
    //    debug($total_biaya);die;
        $response	= array(
            'table'		=> $this->load->view('reporting/ovh_perunit_actual/table',$data,true),
        );
    ...
    function save_overhead_unit() {
        ...
        $table = 'act_tbl_budget_unitcogs_' . post('tahun');

        $ovh= get_data('tbl_fact_product_ovh_actual a',[
