						...
						table_open('table table-bordered table-app table-hover table-1');
							thead();
								...
								tr();
									...
									th('Budget Ovh / unit','','rowspan="2" class="text-center align-middle headcol" ');
...
function getData() {
		...
		var page = base_url + 'reporting/ovh_perunit_actual/data';
...
function lanjut() {
	$.ajax({
		url : base_url + 'reporting/ovh_perunit_actual/save_overhead_unit/',
...
/* Special handling for rowspan columns - Overhead/Unit, Volume Produksi, Total FOH */
