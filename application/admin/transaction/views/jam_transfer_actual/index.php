...
<div class="content-body">
	<?php
	table_open('',true,base_url('transaction/jam_transfer_actual/data'),'tbl_jam_transfer_allocation_actual');
		thead();
			tr();
...
modal_open('modal-form','','','data-openCallback="formOpen"');
	modal_body();
		form_open(base_url('transaction/jam_transfer_actual/save'),'post','form');
			col_init(3,9);
			input('hidden','id','id');
...
modal_open('modal-import',lang('impor'));
	modal_body();
		form_open(base_url('transaction/jam_transfer_actual/import'),'post','form-import');
			col_init(3,9);
...
<script>
	$(document).ready(function() {
		var url = base_url + 'transaction/jam_transfer_actual/data/' ;
