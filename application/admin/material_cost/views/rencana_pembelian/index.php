...
modal_body();
	form_open(base_url('material_cost/rencana_pembelian/import'),'post','form-import');
		col_init(3,9);
...
<script type="text/javascript">
	...
	function save_perubahan() {
		...
		$.ajax({
			url: base_url + 'material_cost/rencana_pembelian/save_perubahan',
			data: {
				'json': jsonString,
	...
	$(document).on('click', '.btn-export', function() {
		...
		table += '<tr><td colspan="1">Rencana Pembelian </td></tr>';
	...
	function download_template(){
		let tahun = $('#tahun').val();
		window.open(base_url + 'material_cost/rencana_pembelian/template?tahun='+tahun)
	}
	...
	// function do_import(){
	// 	$.ajax({
	// 		url: base_url + 'material_cost/rencana_pembelian/import',
	// 		data: {
	// 			tahun: $('#tahun').val(),
	...
	function refresh_page() {
        $(document).on('click', '.swal-button--confirm', function(){
            setTimeout(function () {
                window.location.href = '<?php echo site_url('material_cost/rencana_pembelian') ?>';
            }, 1000);
        })
    }
