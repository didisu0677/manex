...
<div class="content-body">
	<?php
	table_open('',true,base_url('material_cost/exchange_rate/data'),'tbl_currency_rates');
		thead();
			tr();
...
modal_open('modal-form');
	modal_body();
		form_open(base_url('material_cost/exchange_rate/save'),'post','form');
			col_init(3,9);
			input('hidden','id','id');
...
modal_open('modal-import',lang('impor'));
	modal_body();
		form_open(base_url('material_cost/exchange_rate/import'),'post','form-import');
			col_init(3,9);
