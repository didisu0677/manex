<?php 
	...
	foreach($produk[$m0->id] as $m2 => $m1) { 
		...
		<tr>
			...
			<td class="text-right"><?php echo isset($m1->yield) ? number_format($m1->yield) : ''; ?></td>
	...
	<tr>
		<td class="sub-1" colspan="4"><b>TOTAL STOCK<?php echo $m0->cost_centre  ?></b></td>
		<?php
			$bgedit ="";
			$contentedit ="false" ;
...
<?php } ;?>
	<tr>
		<td class="sub-1" colspan="4"><b>GRAND TOTAL</b></td>
		<?php
			$bgedit ="";
			$contentedit ="false" ;
