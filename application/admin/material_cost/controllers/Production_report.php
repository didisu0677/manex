...
class Production_report extends BE_Controller {
    ...
    function data($tahun="",$cost_centre="",$tipe = 'table'){
        ...
        $response	= array(
            'table'		=> $this->load->view('material_cost/production_report/table',$data,true),
        );
        ...
        // $totalData = array();
            ...
            for ($i=8; $i <= $count_import[0]; $i++) { 
                ...
                $data_prod = [
                    ...
                    'product_qty' => @$data['B_01']??0+@$data['B_02']??0+@$data['B_03']??0+@$data['B_04']??0+@$data['B_05']??0+@$data['B_06']??0+@$data['B_07']??0+@$data['B_08']??0+@$data['B_09']??0+@$data['B_10']??0+@$data['B_11']??0+@$data['B_12']??0,
                    'qty_production' => @$data['B_01']??0+@$data['B_02']??0+@$data['B_03']??0+@$data['B_04']??0+@$data['B_05']??0+@$data['B_06']??0+@$data['B_07']+@$data['B_08']+@$data['B_09']+@$data['B_10']??0+@$data['B_11']??0+@$data['B_12']??0,
                 ] ;
